...
class SpectrogramConv(UsefulTFGraph):
    ...
    def build(self, cnfg):
        ...
        with self.as_default():
            ...
            X_conv1_h = math.ceil(cnfg.X_img_h / cnfg.conv1_mp_strides)
            X_conv1_w = math.ceil(cnfg.X_img_w / cnfg.conv1_mp_strides)
            n_flat = X_conv1_h * X_conv1_w * cnfg.conv1_n_filters
            X1 = tf.reshape(X_conv1, [-1, n_flat])
