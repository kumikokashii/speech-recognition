...
class TestSpectrogram2Conv(UsefulTFGraph):
    ...
    def build(self, cnfg):
        ...
        with self.as_default():
            ...
            X_conv2_h = math.ceil(math.ceil(cnfg.X_img_h / cnfg.conv1_mp_strides) / cnfg.conv2_mp_strides)
            X_conv2_w = math.ceil(math.ceil(cnfg.X_img_w / cnfg.conv1_mp_strides) / cnfg.conv2_mp_strides)
            n_flat = X_conv2_h * X_conv2_w * cnfg.conv2_n_filters
            X1 = tf.reshape(X_conv2, [-1, n_flat])
